#!/usr/bin/env python3
"""Build the Going Mobile launcher's .ico from a square crop of the banner art.
...
Usage:
    python tools/make_icon.py <image> [--box X,Y,W,H]
        [-o goingmobile/port/src/launcher/assets/goingmobile.ico]
...
def main():
    ...
    parser.add_argument("-o", "--output", default=os.path.join(
        "goingmobile", "port", "src", "launcher", "assets", "goingmobile.ico"))
