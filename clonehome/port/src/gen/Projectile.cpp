...
Projectile::Projectile(Game* var1) {
  game = var1;
  this->reset();
}
...
void Projectile::detonate(bool var1) {
  if ((!this->detonated)) {
    this->detonated = true;
    {
      int var4;
...
void Projectile::update(bool var1) {
...
void Projectile::homeInOnTarget() {
  if ((this->homingTarget == (-1))) {
    ...
    int var9 = ((game->enemies[this->homingTarget]->feetY() + Enemy::bodyOffsetY[game->enemies[this->homingTarget]->type]) + (Enemy::bodyHeight[game->enemies[this->homingTarget]->type] >> 1));
    ...
    if (((this->type >= 18) && (this->type <= 20))) {
      ...
      if ((jlang::abs<int>((int)(var12)) > jlang::abs<int>((int)(var6)))) {
        if ((var12 > 0)) {
          this->velX = var7;
        } else {
          this->velX = (-var7);
...
void Projectile::draw(Surface* var1, Game* var2) {
  int var3 = Game::cameraX;
  int var4 = Game::cameraY;
  if (((this->type >= 21) && (this->type <= 30))) {
    int16_t var13 = sprites[0]->height;
    int16_t var14 = sprites[0]->width;
