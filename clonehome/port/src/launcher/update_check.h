...
// "dawnstar-vX.Y.Z"/"oblivion-vX.Y.Z"/"clonehome-vX.Y.Z", so "the latest
...
struct ReleaseInfo {
    std::string tag;          // "clonehome-v0.1.0"
    std::string version;      // "0.1.0" -- the tag with the "clonehome-v" prefix removed
    std::string assetName;    // "CloneHomeRemastered-clonehome-v0.1.0-win64.zip"
...
// `tagPrefix` (e.g. "clonehome-v") and has a downloadable .zip asset.
