...
public final class f extends FullCanvas implements Runnable {
   ...
   private void a(Graphics var1) {
      if (this.ae != null) {
         ...
         var1.drawImage(this.ae, 64, 64, 3);
         this.ae = null;
         System.gc();
      }
   }
   ...
   private void c(Graphics var1) {
      ...
      if (this.X.J != 6 && this.X.J != 0) {
         a.a(var1, String.valueOf(this.X.K[this.X.J]), 13, 5, 20);
      }

      a.a(var1, String.valueOf(this.as), 114, 5, 24);
   ...
   private int a(Graphics var1, int var2) {
      ...
      if (this.bo >= 0 && this.ce[this.bo][this.bp - 1] >= 0) {
         ...
         var1.drawImage(ah, 0, 98 - 24 * this.ce[this.bo][this.bp - 1], 20);
         var1.setClip(0, 0, 128, 128);
      }

      int var7 = this.bn.length();
      if ((var2 = a(var1, var2, this.bn, var3, 95, var5, 128 - var3)) >= var7) {
         return -1;
      }

      if ((var2 = a(var1, var2, this.bn, var3, 105, var5, 128 - var3)) >= var7) {
         return -1;
      }

      int var11;
      return (var11 = a(var1, var2, this.bn, var3, 115, var5, 128 - var3)) >= var7 ? -1 : var11;
   }
   ...
   public final void a(byte[] var1) {
      var1[0] = 1;
      ratchetandclank.a(this.bw, var1, 1);
      ratchetandclank.a(this.aS, var1, 5);
      ratchetandclank.a(this.aT, var1, 9);
      ratchetandclank.a(this.bu, var1, 13);
      var1[17] = this.X.M;

      for (int var2 = 0; var2 < 8; var2++) {
         var1[18 + var2] = this.X.N[var2];
         ratchetandclank.a(this.X.L[var2], var1, 26 + var2 * 2);
         ratchetandclank.a(this.X.K[var2], var1, 42 + var2 * 2);
      }

      ratchetandclank.a(this.as, var1, 58);
      ratchetandclank.a(this.be, var1, 195);
      ratchetandclank.a(this.bv, var1, 204);
      ratchetandclank.a(bP, var1, 208);
      ratchetandclank.a(this.bx, var1, 212);
      ratchetandclank.a(bQ, var1, 216);
   }

   public final void b(byte[] var1) {
      this.bw = ratchetandclank.a(var1, 1);
      this.aS = ratchetandclank.a(var1, 5);
      this.aT = ratchetandclank.a(var1, 9);
      this.bu = ratchetandclank.a(var1, 13);
      this.X.M = var1[17];

      for (int var2 = 0; var2 < 8; var2++) {
         this.X.N[var2] = var1[18 + var2];
         this.X.L[var2] = ratchetandclank.b(var1, 26 + var2 * 2);
         this.X.K[var2] = ratchetandclank.b(var1, 42 + var2 * 2);
      }

      this.as = ratchetandclank.a(var1, 58);
      this.be = ratchetandclank.a(var1, 195);
      this.bv = ratchetandclank.a(var1, 204);
      bP = ratchetandclank.a(var1, 208);
      this.bx = ratchetandclank.a(var1, 212);
      bQ = ratchetandclank.a(var1, 216);
      this.cr = this.bg = 0;
   }
   ...
   private void N() {
      ...
      this.o();
      this.d = true;
      ratchetandclank.e = ratchetandclank.a("/m", 145);
   }
