...
enum class Action { Left, Right, Up, Down, Jump, Fire, Melee, Wheel, Pause, Confirm, Back, Count };
...
void keyEvent(unsigned virtualKey, bool down, bool isRepeat);  // WM_KEYDOWN / WM_KEYUP
