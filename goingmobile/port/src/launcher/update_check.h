...
// "dawnstar-vX.Y.Z"/"oblivion-vX.Y.Z"/"goingmobile-vX.Y.Z", so "the latest
...
struct ReleaseInfo {
    std::string tag;          // "goingmobile-v0.1.0"
    std::string version;      // "0.1.0" -- the tag with the "goingmobile-v" prefix removed
    std::string assetName;    // "GoingMobileRemastered-goingmobile-v0.1.0-win64.zip"
...
// `tagPrefix` (e.g. "goingmobile-v") and has a downloadable .zip asset.
