...
// to unit-test it. Ported from dawnstar's own port/src/launcher/
// zip_reader.h (itself from shadowkey-decomp) -- a verbatim copy other
// than the namespace: nothing in a zip reader is specific to any one game.
//
...
// stormhold `.jar` and a release `.zip` are a few MB.
