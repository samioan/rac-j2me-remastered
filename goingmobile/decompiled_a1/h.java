...
public final class h {
   ...
   public static byte F = 42;
   public static byte G = 28;
   ...
   public int aY;
   public int[] aZ;
   public static byte ba = 10;
   public static byte bb = ba;
   public short[] bc;
   public short[] bd;
   public short[] be;
   public short[] bf;
   ...
   public final void a(int var1, int var2) {
      for (int var3 = 0; var3 < 8; var3++) {
         if (this.bj[var3] == -1) {
            this.bj[var3] = (short)(var1 * F + (F >> 1));
            this.bk[var3] = (short)(var2 * G + (G >> 1));
            return;
         }
      }
   }
   ...
   public final void a() {
      short var1 = this.aj.b();
      int var2 = this.aj.c() + L;
      boolean var3 = false;
      boolean var4 = false;
      boolean var5 = false;
      boolean var6 = false;
   ...
   public final void b(Graphics var1) {
      if (this.bX != -1) {
         boolean var2 = false;
         boolean var3 = false;
         int var4 = this.bX * F + x + (F - 19 >> 1);
         int var5 = this.bY * G + y + (G - 19 >> 1);
   ...
   public final void b() {
      if (this.bX != -1) {
         ...
         int var3 = this.bX * F;
         int var4 = this.bY * G;
         if (this.a(this.aj.b() - 11, this.aj.c() + L + 7, 18, 37, var3, var4, 19, 19)) {
            this.bX = this.bY = -1;
            this.bZ = false;
            this.cC = true;
            this.cI = cz[34];
   ...
   public final void c(Graphics var1) {
      if (this.cc != -1) {
         ...
         byte var4 = L;
         int var5 = this.cc * F + x;
         int var6 = this.cd * G + y + var4;
   ...
   public final int e() {
      ...
      for (int var2 = this.ai.length - 1; var2 >= 0; var2--) {
         if (this.ai[var2].Z != 4 && this.ai[var2].Z != -1) {
            var1++;
         }
      }
   ...
   public h(ratchetandclank var1) {
      this.a = var1;
      Display.getDisplay(this.a);
   }
   ...
   public final void a(int var1) throws Exception {
      switch (var1) {
         case 4:
            try {
               ratchetandclank.h = new a("/f2.v", 10, 1);
               ratchetandclank.g = ratchetandclank.h;
               ratchetandclank.f = new a("/f3.v", 13, 1);
         ...
         case 40:
            ...
            for (byte var2 = (byte)(ba - 1); var2 >= 0; var2--) {
               this.ai[var2] = new f(this);
            }
            ...
            for (int var4 = 9; var4 >= 0; var4--) {
               this.ak[var4] = new j(this);
            }

            this.al = new j[10];

            for (int var5 = 9; var5 >= 0; var5--) {
               this.al[var5] = new j(this);
            }
   ...
   public final void d(Graphics var1) {
      ...
      boolean var4 = false;
      this.a.b.a(var1, (byte)0);
      var1.setClip(0, 0, 176, 220);
      int var2 = this.a.b.a(var1, ratchetandclank.n[38]);
      ratchetandclank.e = ratchetandclank.h;
      var2 += ratchetandclank.h.a;
      int var6;
      this.dc[0] = var6 = ap.getHeight() / 2 + var2;
      this.dc[1] = var2 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[39], F + (F >> 1), var6, 0, this.cu == 0);
      int var8;
      this.dc[2] = var8 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[3], F + (F >> 1), var2, 0, this.cu == 1);
      this.dc[3] = var2 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[41], F + (F >> 1), var8, 0, this.cu == 2);
      this.a.b.a(var1, ratchetandclank.n[42], F + (F >> 1), var2, 0, this.cu == 3);
      this.a.b.a(var1, 7, 8, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
      var1.setColor(255, 255, 255);
      this.a(var1, ratchetandclank.n[213 + this.o], this.I - 10, 20, 156);
   }
   ...
   public final void f(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[27]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      this.a.b.a(var1, this.a.k ? ratchetandclank.n[28] : ratchetandclank.n[29], F + (F >> 1), 100, 0, this.cu == 0);
      this.a.b.a(var1, 7, 8, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
   }
   ...
   public final void g(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[283]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 104;
      int var2;
      this.dc[1] = var2 = 4 + this.a.b.a(var1, (byte)0, F + (F >> 1), 104, 0, this.cu == 0);
      int var3;
      this.dc[2] = var3 = 4 + this.a.b.a(var1, (byte)1, F + (F >> 1), var2, 0, this.cu == 1);
      this.a.b.a(var1, (byte)2, F + (F >> 1), var3, 0, this.cu == 2);
      this.a.b.a(var1, 7, 8, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
   }
   ...
   public final void h(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[47]);
      ratchetandclank.e = ratchetandclank.h;
      if (this.ec != 7) {
         this.aj.L = (byte)(this.ec + 1);
      }

      this.aj.a(var1, 0, 0, -20);
      var1.setClip(0, 0, 176, 220);
      if (this.ec == 7) {
         var2 = this.a.b.a(var1, ratchetandclank.n[58], F + (F >> 1), 85, 0, false);
         var2 = this.a.b.a(var1, ratchetandclank.n[295], F + (F >> 1), var2, 0, true);
         var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
         var2 = this.a.b.a(var1, 57, this.aj.Q, F + (F >> 1), var2, 0, false);
      } else if ((this.aj.O & 1 << this.ec + 1) != 0) {
         var2 = this.a.b.a(var1, ratchetandclank.n[58], F + (F >> 1), 85, 0, false);
         var2 = this.a.b.a(var1, ratchetandclank.n[49 + this.ec], F + (F >> 1), var2, 0, true);
         var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
         var2 = this.a.b.a(var1, 57, this.aZ[this.ec + 1], F + (F >> 1), var2, 0, false);
      } else {
         var2 = 85 + ratchetandclank.e.a;
         var2 = this.a.b.a(var1, ratchetandclank.n[49 + this.ec], F + (F >> 1), var2, 0, true);
         var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
         var2 = this.a.b.a(var1, 57, b.h[this.ec], F + (F >> 1), var2, 0, false);
      }

      int var13;
      this.dc[0] = var13 = var2 + ratchetandclank.e.a / 2;
      this.dc[1] = var2 = this.a.b.a(var1, ratchetandclank.n[11], F + (F >> 1), var13, 0, this.cu == 0) + 3;
      this.a.b.a(var1, ratchetandclank.n[10], F + (F >> 1), var2, 0, this.cu == 1);
      ratchetandclank.e = ratchetandclank.g;
      this.a.b.a(var1, F + (F >> 1), this.dc[this.cu]);
      this.a.b.a(var1, 7, 8, this);
   }
   ...
   public final void i(Graphics var1) {
      ...
      this.a.b.a(var1, (byte)0);
      var1.setClip(0, 0, 176, 220);
      this.a.b.a(var1, ratchetandclank.n[26]);
      ratchetandclank.e = ratchetandclank.h;
      this.e(var1);
      var2 = 85 + var4 + 4;
      if (this.cu != 7) {
         this.aj.L = (byte)(this.cu + 1);
      }
      ...
      if ((this.cu != 2 || !this.h(3) || !this.h(8)) && (this.cu != 3 || !this.h(8))) {
         if (this.cu == 7) {
            var2 = this.a.b.a(var1, ratchetandclank.n[58], F + (F >> 1), var2, 0, false);
            var2 = this.a.b.a(var1, ratchetandclank.n[295], F + (F >> 1), var2, 0, true);
            var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
            var2 = this.a.b.a(var1, 57, this.aj.Q, F + (F >> 1), var2, 0, false);
            if (this.aj.Q <= 0) {
               this.a.b.a(var1, ratchetandclank.n[257], F + (F >> 1), var2, 0, false);
            }
         } else if ((this.aj.O & 1 << this.cu + 1) > 0) {
            var2 = this.a.b.a(var1, ratchetandclank.n[58], F + (F >> 1), var2, 0, false);
            var2 = this.a.b.a(var1, ratchetandclank.n[49 + this.cu], F + (F >> 1), var2, 0, true);
            var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
            var2 = this.a.b.a(var1, 57, this.aZ[this.cu + 1], F + (F >> 1), var2, 0, false);
            if (this.aj.M[this.cu + 1] < b.d[3 * (this.cu + 1) + this.aj.P[this.cu + 1]]) {
               Object[] var27 = new Object[]{new Integer(this.aj.M[this.cu + 1]), new Integer(b.d[3 * (this.cu + 1) + this.aj.P[this.cu + 1]])};
               String var29 = this.a(ratchetandclank.n[255], var27);
               this.a.b.a(var1, var29, F + (F >> 1), var2, 0, false);
            } else {
               this.a.b.a(var1, ratchetandclank.n[257], F + (F >> 1), var2, 0, false);
            }
         } else {
            ...
            var2 = this.a.b.a(var1, ratchetandclank.n[49 + this.cu], F + (F >> 1), var2, 0, true);
            var2 = this.a.b.a(var1, 56, this.aX, F + (F >> 1), var2, 0, false);
            this.a.b.a(var1, 57, b.h[this.cu], F + (F >> 1), var2, 0, false);
         }
      } else {
         var2 += 15;
         ratchetandclank.e = ratchetandclank.g;
         var1.setColor(12632256);
         var2 = this.a(var1, ratchetandclank.n[49 + this.cu], 88, var2, 17, this.i());
         ratchetandclank.e = ratchetandclank.h;
         Object[] var8 = new Object[]{new Integer(this.aX)};
         String var9 = this.a(ratchetandclank.n[56], var8);
         var2 = this.a(var1, var9, 88, var2, 17, this.i());
         this.a(var1, ratchetandclank.n[253], 88, var2, 17, this.i());
      }
      ...
      this.a.b.b(var1, var3, 5 + ((this.aj.O & 32) > 0 ? 1 : 0) + ((this.aj.O & 128) > 0 ? 1 : 0));
      this.a.b.a(var1, 254, 8, this);
      ...
      for (int var28 = 0; var28 < 4 + ((this.aj.O & 32) > 0 ? 1 : 0); var28++) {
   ...
   public final void a(Graphics var1, byte var2) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[296]);
      var1.setColor(16777215);
      ratchetandclank.e = ratchetandclank.h;
      var1.getFont();
      var3 = 87;
      switch (var2) {
         case 0:
            this.a(var1, ratchetandclank.n[this.dC], 18, 107, 17, this.i());
            break;
         case 1:
            var1.setClip(0, 0, 176, 220);
            var3 = this.a(var1, ratchetandclank.n[297] + " " + do, 88, 85, 17, this.i());
            var3 = this.a(var1, ratchetandclank.n[298] + " " + dq, 88, var3, 17, this.i());
            var3 = this.a(var1, ratchetandclank.n[299] + " " + dr, 88, var3, 17, this.i());
            var3 = this.a(var1, ratchetandclank.n[300] + " " + this.a.b.c((int)dw), 88, var3, 17, this.i());
            this.a(var1, ratchetandclank.n[301] + " " + this.a.b.c((int)dx[dy]), 88, var3, 17, this.i());
            break;
         case 2:
            if (dG) {
               var3 = this.a.b.a(var1, ratchetandclank.n[302], 88, 87, 17, false);
            }

            if (dF) {
               var3 = this.a.b.a(var1, ratchetandclank.n[303], 88, var3, 17, false);
            }

            if (dH) {
               this.a.b.a(var1, ratchetandclank.n[304], 88, var3, 17, false);
            }
      }

      if (var2 > 0) {
         this.a.b.a(var1, ratchetandclank.n[305] + " " + dz, 88, 166, 17, true);
      }

      this.a.b.a(var1, 9, -1, this);
   }
   ...
   public final void j(Graphics var1) {
      try {
         this.a.b.a(var1, (byte)0);
         var1.setClip(0, 0, 176, 220);
         this.a.b.a(var1, ratchetandclank.n[12]);
         ...
         var1.drawImage(ao, (176 - ao.getWidth()) / 2, 220 - this.a.b.a() - ao.getHeight() + 8, 0);
         this.a.b.a(var1, ratchetandclank.n[14 + this.cQ[this.cu] - 1], (176 - ao.getWidth()) / 2, 220 - this.a.b.a() - ao.getHeight() + 12, 0, true);
         ...
         if (this.cQ[this.cu] < 11) {
            ...
            var1.drawImage(aA, this.a.b.b() / 2, 120 + var14, 0);
            var1.setColor(1370860);
            ratchetandclank.e.a(var1, this.i(this.cQ[this.cu]) + "/" + var25, 7 + this.a.b.b() / 2, 137 + var14, 0);
         }
      } catch (Exception var19) {
      }

      this.a.b.a(var1, 7, -1, this);
   }
   ...
   public final void k(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[43]);
      ratchetandclank.e = ratchetandclank.h;
      this.a(var1, ratchetandclank.n[285], 88, 110, 17, this.i());
      this.a.b.a(var1, 9, -1, this);
   }
   ...
   public final void l(Graphics var1) {
      ...
      this.a.b.a(var1, (byte)0);
      var1.setClip(0, 0, 176, 220);
      var2 = this.a.b.a(var1, ratchetandclank.n[75]) + (ratchetandclank.e.a >> 1);
      ...
      var1.setColor(16777215);
      ratchetandclank.e = ratchetandclank.h;
      var2 = this.a.b.a(var1, ratchetandclank.n[306] + " " + this.a.b.c(this.cr), 88, 85, 17, false);
      var2 = this.a.b.a(var1, ratchetandclank.n[299] + " " + this.v(), 88, var2, 17, false);
      var2 += 5;
      this.a.b.a(var1, ratchetandclank.n[307] + " " + dA, 88, var2, 17, true);
      this.a.b.a(var1, 9, -1, this);
   }
   ...
   public final void m(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[308]);
      ratchetandclank.e = ratchetandclank.h;
      this.a(var1, ratchetandclank.n[309], 88, 131, 33, this.i());
      this.a.b.a(var1, 9, -1, this);
   }
   ...
   public final void n(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[75]);
      ratchetandclank.e = ratchetandclank.h;
      int var2;
      if (this.X < 11) {
         var2 = this.a(var1, ratchetandclank.n[251], (176 - this.i()) / 2, 87, 0, this.i());
      } else {
         var2 = this.a(var1, ratchetandclank.n[252], (176 - this.i()) / 2, 87, 0, this.i());
      }

      Object[] var3 = new Object[]{new Integer(cl[this.X])};
      this.cE = null;
      this.cE = this.a(ratchetandclank.n[250], var3);
   ...
   public final void o(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[24]);
      int var2 = 87;
      ratchetandclank.e = ratchetandclank.h;
      if (this.cW) {
         var2 = this.a(var1, ratchetandclank.n[228], (176 - this.i()) / 2, 87, 0, this.i());
      }

      if (this.cX) {
         var2 = this.a(var1, ratchetandclank.n[230], (176 - this.i()) / 2, var2, 0, this.i());
      }

      var2 = this.a(var1, ratchetandclank.n[229], (176 - this.i()) / 2, var2, 0, this.i());
      if (this.cZ) {
         Object[] var3 = new Object[]{new String(ratchetandclank.n[this.aj.L + 48])};
         this.cE = null;
         this.cE = this.a(ratchetandclank.n[231], var3);
         var2 = this.a(var1, this.cE, (176 - this.i()) / 2, var2, 0, this.i());
      }

      Object[] var5 = new Object[]{new Integer(cl[this.X])};
      this.cE = null;
      this.cE = this.a(ratchetandclank.n[249], var5);
      this.a(var1, this.cE, (176 - this.i()) / 2, var2, 0, this.i());
      this.a.b.a(var1, 9, 8, this);
   }
   ...
   public final void b(Graphics var1, byte var2) {
      ...
      for (int var8 = 0; var8 < 12; var8++) {
         if ((this.cL & 1 << 20 + var8) != 0
            && (var3 = this.a.b.a(var1, ratchetandclank.n[60 + var8], F + (F >> 1), var3, 0, this.cu == var8)) >= this.k() + this.h() - 2 * this.h() / 10) {
            if (var8 >= this.cu) {
               break;
            }
   ...
   public final void p(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[282]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      int var2;
      this.dc[1] = var2 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[11], F + (F >> 1), 100, 0, this.cu == 0);
      this.a.b.a(var1, ratchetandclank.n[10], F + (F >> 1), var2, 0, this.cu == 1);
      this.a.b.a(var1, 7, -1, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
   }
   ...
   public final void q(Graphics var1) {
      ...
      for (int var10 = 1; var10 <= 7; var10++) {
         if ((this.aj.O & 1 << var10) == 0) {
            this.b(var1, 0 + dM[var10 - 1][0], var9 + dM[var10 - 1][1]);
         }
      }

      if (this.aj.L > 0) {
         this.a(var1, 0 + dM[this.aj.L - 1][0], var9 + dM[this.aj.L - 1][1]);
      }

      int var2 = 110 - 3 * ratchetandclank.e.a / 2 + var5;
      var1.setColor(16777215);
      var2 = this.a(var1, ratchetandclank.n[48 + this.aj.L], 88, var2, 17, 2 * aB.getWidth() / 4);
      var2 = this.a(var1, ratchetandclank.n[310] + " " + (this.aj.P[this.aj.L] + 1), 88, var2, 17, 2 * aB.getWidth() / 4);
      if (this.aj.L != 6) {
         this.a(var1, ratchetandclank.n[232] + ": " + this.aj.M[this.aj.L], 88, var2, 17, 2 * aB.getWidth() / 4);
      }
   }
   ...
   public final void r(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[59]);
      ratchetandclank.e = ratchetandclank.h;
      this.a.b.a(var1, -1, 8, this);
   }
   ...
   public final void s(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[44]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      int var2;
      this.dc[1] = var2 = 4 + this.a.b.a(var1, ratchetandclank.n[11], F + (F >> 1), 100, 0, this.cu == 0);
      this.a.b.a(var1, ratchetandclank.n[10], F + (F >> 1), var2, 0, this.cu == 1);
      this.a.b.a(var1, 7, 8, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
   }
   ...
   public final void t(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[281]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      int var2;
      this.dc[1] = var2 = this.a.b.a(var1, ratchetandclank.n[40], F + (F >> 1), 100, 0, this.cu == 0) + 5;
      this.a.b.a(var1, ratchetandclank.n[280], F + (F >> 1), var2, 0, this.cu == 1);
      this.a.b.a(var1, 7, -1, this);
      this.a.b.a(var1, F >> 1, this.dc[this.cu]);
   }
   ...
   public final void u(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[45]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      int var2;
      this.dc[1] = var2 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[11], F + (F >> 1), 100, 0, this.cu == 0);
   ...
   public final void v(Graphics var1) {
      ...
      var1.setClip(0, 0, 176, 220);
      this.e(var1);
      this.a.b.a(var1, ratchetandclank.n[46]);
      ratchetandclank.e = ratchetandclank.h;
      this.dc[0] = 100;
      int var2;
      this.dc[1] = var2 = ap.getHeight() / 2 + this.a.b.a(var1, ratchetandclank.n[11], F + (F >> 1), 100, 0, this.cu == 0);
   ...
   public final void w(Graphics var1) {
      if (this.U <= 0) {
         if (!this.m) {
               ...
               switch (this.b) {
                  ...
                  default:
                     ...
                     if (this.b != 16 && this.b != 17 && this.b != 24) {
                        ...
                        var1.setClip(0, 0, 176, H);
                        var1.setColor(0);
                        var1.fillRect(0, 0, 176, H);
                        var1.setClip(0, 220 - H, 176, H);
                        var1.setColor(0);
                        var1.fillRect(0, 220 - H, 176, H);
                        this.a.b.a(var1, -1, -1, this);
                     }
                     ...
                     if (this.Z == 11) {
                        ...
                        ratchetandclank.e.a(var1, ratchetandclank.n[311] + " " + this.db, 88, 220 - H + 3, 17);
                     }
                     ...
                     if (this.n == 2 && this.dY > 0) {
                        var1.setColor(16777215);
                        ratchetandclank.e = ratchetandclank.h;
                        ratchetandclank.e.a(var1, "" + 1000 / this.dY + "." + 100000 / this.dY % 100, 0, H, 20);
                     }
   ...
   public final void b(byte var1) {
      switch (var1) {
         ...
         case 1:
            ...
            this.aj.a((byte)2);
            this.d = true;
            this.aj.ac = (short)(this.aj.ac + 256);
            this.aj.ag = this.aj.ag + this.aj.ac;
            this.aj.ab = this.aj.ab + this.aj.ad;
            this.aj.v();
            short var3 = this.aj.a(false);
            if (this.aj.c() >= var3 && this.aj.ac > 0) {
               this.aj.a((byte)4);
               this.aj.ag = 0;
               this.aj.ac = -3584;
               this.h++;
         ...
         case 2:
            ...
            this.aj.ag = this.aj.ag + this.aj.ac;
            this.aj.v();
            short var2 = this.aj.a(false);
            if (this.aj.c() >= var2 && this.aj.ac > 0) {
               this.aj.a((byte)4);
               this.aj.ag = 0;
               this.aj.ac = -3584;
               this.aj.am = 0;
      ...
      switch (var1) {
         case 0:
            ...
            if (this.aj.s != -1) {
               ...
               if (this.aj.aa <= 8 && this.aj.ab >> 8 < 13 * F) {
                  if (this.aj.ab >> 8 > 11 * F + (F >> 1)) {
                     this.aj.a((byte)0);
                     this.aj.am = 0;
                     this.s = 4;
            ...
            return;
         case 1:
            short var6 = this.aj.a(false);
            this.aj.n();
            this.d = true;
            if (this.t) {
               var6 = this.aj.a(false);
               this.d = true;
               this.aj.ab = this.aj.ab + this.aj.ad;
               this.aj.ac = (short)(this.aj.ac + 256);
               this.aj.ag = this.aj.ag + this.aj.ac;
         ...
         case 2:
            ...
            this.aj.ag = this.aj.ag + this.aj.ac;
            this.aj.v();
            short var5 = this.aj.a(false);
            if (this.aj.c() >= var5 && this.aj.ac > 0) {
               this.aj.a((byte)4);
               this.aj.ag = 0;
               this.aj.ac = -3584;
               this.aj.am = 0;
   ...
   private void U() {
      ...
      int var3 = G * 9 - G;
      int var4 = 2 * G;
      this.e(var1 + this.d(this.W.nextInt()) % var2 << 8, var3 + this.d(this.W.nextInt()) % var4 << 8, 30);
   }
   ...
   public final void d(byte var1) {
      switch (var1) {
         ...
         case 3:
            this.ai[9].i();
            this.d = true;
            int var4 = this.ai[9].a(false);
            this.ai[9].ac = (short)(this.ai[9].ac + 256);
            this.ai[9].ag = this.ai[9].ag + this.ai[9].ac;
            this.ai[9].v();
            if (this.ai[9].b() + 2 * G >= var4 && this.ai[9].ac > 0) {
               this.ai[9].a((byte)0);
               this.ai[9].am = 0;
               this.b = 0;
               this.cC = true;
         ...
         case 6:
            ...
            this.aj.a((byte)2);
            this.d = true;
            this.aj.ac = (short)(this.aj.ac + 384);
            this.aj.ag = this.aj.ag + this.aj.ac;
            this.aj.ab = this.aj.ab + this.aj.ad;
            this.aj.v();
            if (this.aj.c() >= 5 * G + (G >> 1) && this.aj.ac > 0) {
               this.aj.a((byte)6);
               int var3 = (this.d(this.be[0] - this.bc[0]) << 8) / 2304;
               this.aj.V = (this.bg[0] << 8) / var3;
               this.aj.W = this.bh[0] / var3;
               this.aj.X = this.bf[0];
               this.k++;
               return;
            }
         ...
         case 8:
            ...
            short var2 = this.aj.a(false);
            this.aj.ac = (short)(this.aj.ac + 256);
            if (this.aj.c() + this.aj.ac > var2 << 8) {
               this.aj.ac = (short)((var2 << 8) - this.aj.c());
            }
         ...
         if (this.cs - this.ct > 33L) {
            ...
            if (this.b == 24) {
               ...
               for (int var1 = 9; var1 >= 0; var1--) {
                  this.ak[var1].b(false);
               }
            }

            if (this.b == 16) {
               for (int var2 = 9; var2 >= 0; var2--) {
                  this.ak[var2].b(false);
               }
            ...
            if (this.b == 0 && !this.cD) {
               ...
               for (int var5 = ba - 1; var5 >= 0; var5--) {
                  if (this.ai[var5].Z != -1) {
                     if (this.Z == 12 && (this.ai[var5].Z == 1 || this.ai[var5].Z == 4)) {
                        if (this.ai[var5].E > 140) {
                           this.ai[var5].Z = -1;
                           continue;
                        }
                        ...
                        this.ai[var5].E++;
                        if (this.ai[var5].E == 1) {
                           this.ai[var5].a((byte)6);
                           this.ai[var5].am = 1;
                        } else if (this.ai[var5].E == 137) {
                           this.ai[var5].a((byte)7);
                           this.ai[var5].am = 1;
                        }
                     }

                     if (this.ai[var5].al != 5 && this.aj.al != 10) {
                        this.q(var5);
                     }

                     this.ai[var5].h();
                     this.ai[var5].i();
                     if (this.Z == 11 && this.ai[var5].Z != 4) {
                        this.db++;
                     }
                  }
               }

               if (this.Z == 0 && this.ai[9].Z == -1 && this.aj.c() >= this.aj.a(false)) {
                  this.b = 17;
                  this.e = false;
                  this.bC[0] = 0;
                  this.aj.a((byte)1);
               ...
               if (this.Z == 12) {
                  if (!this.g && this.aj.ab >> 8 >= 6 * F && this.aj.ab >> 8 <= 9 * F && this.aj.c() >= this.aj.a(false)) {
                     this.b = 16;
                     this.e = false;
                     this.aj.a((byte)1);
                     this.aj.am = 0;
   ...
   public final void s() {
      int var1 = 0;
      int var2 = 0;
      short var4 = this.aj.b();
      short var5 = this.aj.c();
      if (!z) {
         if (this.aj.ao) {
            var1 = -(var4 - F);
         } else {
         ...
         var1 = -(E - 88);
         if (var4 > E + (F >> 1) || var4 < E - (F >> 1) || this.aj.c() == this.aj.a(false)) {
            z = false;
         }
      }
   ...
   public final void f(int var1) {
      ...
      if (var1 == 0) {
         ...
         this.ad = 1;
         this.ae = 5;
         this.aj.ab = this.ad * F + (J >> 1) << 8;
         this.aj.aa = this.aj.af = this.ae;
         this.aj.aj = 1;
         this.aj.ak = 0;
         this.aj.al = 0;
         this.aj.am = 0;
   ...
   public final void a(int var1, short var2) {
      ...
      try {
         ...
         for (int var3 = 0; var3 < 8; var3++) {
            this.aj.S[var3] = this.aj.N[var3];
            this.aj.U[var3] = this.aj.P[var3];
            this.aj.T[var3] = this.aj.M[var3];
         }
   ...
   private void s(int var1) {
      if (var1 >= 0 && var1 <= 11) {
         ...
         for (int var5 = 0; var5 < 8; var5++) {
            this.aj.M[var5] = b.d[var5 * 3 + this.aj.P[var5]];
         }
   ...
   public final void A() {
      if (this.cX && this.aj.ai != 20) {
         ...
         if (this.cZ && this.aj.O != 1 && this.aj.M[this.aj.L] <= 0) {
            this.y();
            this.b = 19;
         } else {
            for (int var1 = ba - 1; var1 >= 0; var1--) {
               if (this.ai[var1].ai > 0 && this.ai[var1].Z != 4 && this.ai[var1].Z != -1) {
                  return;
               }
            }
         }
   ...
   private void V() {
      ...
      switch (this.ed) {
         case 1:
            this.aj.aa = this.aj.af = 1;
            y = 0;
            break;
         case 2:
            this.aj.ab = 1 * F + (J >> 1) << 8;
            x = 0;
         case 3:
         case 4:
         default:
            break;
         case 5:
            this.aj.ab = 26 * F + (J >> 1) << 8;
            x = v;
            break;
         case 6:
            this.aj.aa = this.aj.af = 16;
            y = w;
      }
   ...
   public final void a(int var1, int var2, int var3) {
      this.aj.w = var1 * F + (F >> 1) + (this.aj.ao ? -5 : 5) << 8;
      this.aj.x = var2 * G + (G >> 1) - 2 << 8;
      int var4 = 4 * F / 44;
      if (!this.aj.ao) {
         var4 = -var4;
      }
      ...
      int var5 = 10 * G / 44;
      this.aj.y = (this.aj.ab >> 8) + var4 << 8;
      this.aj.z = this.aj.aa * G + (this.aj.ag >> 8) + var5 << 8;
      this.aj.A = (this.aj.w - this.aj.y) / 6;
      this.aj.B = (this.aj.x - this.aj.z) / 6;
      if (this.aj.x < this.aj.z) {
         this.aj.F = (byte)var3;
         this.aj.u = 0;
         this.aj.a((byte)5);
         this.aj.am = 2;
   ...
   public final short B() {
      ...
      for (int var3 = 3; var3 >= 0; var3--) {
         if (this.cq[var3] != -1
            && this.cm[var3] + this.co[var3] <= (this.aj.ab >> 8) + 8
            && this.cm[var3] + this.co[var3] + F >= (this.aj.ab >> 8) - 8
   ...
   public final short C() {
      short var1 = (short)(18 * G);
      short var2 = this.aj.c();
      int var3 = this.aj.ab >> 8;
      boolean var4 = false;
   ...
   public final boolean D() {
      ...
      byte var4 = G;
      boolean var5 = false;
      int var6 = this.aj.ab >> 8;
      short var7 = this.aj.c();
      boolean var8 = false;
      int var9 = var4 - 1;

      for (int var10 = 49; var10 >= 0; var10--) {
         if (this.bn[var10] >= 0
            && this.d(this.bl[var10] - var6) <= var3
            && this.d(this.bm[var10] - var7) <= var4
   ...
   public final boolean k(int var1) {
      short var9 = this.aj.b();
      int var10 = this.aj.c() + L;
      boolean var11 = false;
      boolean var12 = false;
      boolean var13 = false;
      boolean var14 = false;
      byte var2 = this.ai[var1].Z;
      if (this.ai[var1].Z != -1 && var2 != 4) {
         if (this.d(this.ai[var1].ab - this.aj.ab) <= F << 8 && this.d(this.ai[var1].aa - this.aj.aa) <= 3 && this.ai[var1].al != 5) {
            short var3 = this.ai[var1].c();
            short var4 = this.ai[var1].b();
            byte var5 = f.a[var2];
            byte var6 = f.b[var2];
            byte var7 = f.c[var2];
            byte var8 = f.d[var2];
   ...
   public final boolean E() {
      ...
      byte var2 = F;
      int var3 = this.aj.ab >> 8;
      short var4 = this.aj.c();
      int var5 = 0;

      for (int var6 = 49; var6 >= 0; var6--) {
         if (this.bn[var6] >= 0
            && ((var5 = this.bl[var6] + (var1 >> 1)) <= var3 || this.aj.ao)
            && (var5 >= var3 || !this.aj.ao)
   ...
   public final boolean F() {
      for (int var2 = ba - 1; var2 >= 0; var2--) {
         byte var1 = this.ai[var2].Z;
         if (this.ai[var2].Z != -1
            && var1 != 4
            && (this.ai[var2].ab <= this.aj.ab || this.aj.ao)
            && (this.ai[var2].ab >= this.aj.ab || !this.aj.ao)
            && this.d(this.ai[var2].ab - this.aj.ab) <= F << 8
            && this.ai[var2].al != 5
            && this.aj.aa == this.ai[var2].aa) {
            return true;
         }
      }
   ...
   public final int G() {
      short var8 = this.aj.b();
      int var9 = this.aj.c() + L;
      boolean var10 = false;
      boolean var11 = false;
      boolean var12 = false;
      boolean var13 = false;

      for (int var14 = ba - 1; var14 >= 0; var14--) {
         byte var1 = this.ai[var14].Z;
         if (this.ai[var14].Z != -1
            && var1 != 4
            && this.d(this.ai[var14].ab - this.aj.ab) <= F << 8
            && this.d(this.ai[var14].aa - this.aj.aa) <= 3
            && this.ai[var14].al != 5) {
            short var2 = this.ai[var14].c();
            short var3 = this.ai[var14].b();
            byte var4 = f.a[var1];
            byte var5 = f.b[var1];
            byte var6 = f.c[var1];
            byte var7 = f.d[var1];
      ...
      if (var1 == -7) {
         ...
         if (var1 != 52 && var2 != -3) {
            if (var1 == 54 || var2 == -4) {
               ...
               while (this.cu > 3 && (this.aj.O & 1 << this.cu + 1) == 0 || this.cu == 5) {
                  if (this.cu == 7) {
                     return;
                  }
               ...
               if (this.cu != 2 || !this.h(3)) {
                  ...
                  if (this.cu == 7 && this.aj.Q <= 0) {
                     return;
                  }

                  if (this.cu != 7 && (this.aj.O & 1 << this.cu + 1) == 0) {
                     this.b = 12;
                     this.ec = this.cu;
                     this.cu = 0;
                     return;
                  ...
                  if (this.cu != 7 && this.aj.M[this.cu + 1] >= b.d[3 * (this.cu + 1) + this.aj.P[this.cu + 1]]) {
                     return;
                  }
   ...
   public final void l(int var1, int var2) {
      if (var2 == -2 || var1 == 56) {
         ...
         if (this.cu == 1) {
            if (this.ec == 7) {
               if (this.aX < this.aj.Q) {
                  this.cu = 0;
                  this.b = 13;
                  return;
               }

               this.aX = this.aX - this.aj.Q;

               for (int var3 = 1; var3 < 8; var3++) {
                  if ((this.aj.O & 1 << var3) > 0) {
                     this.aj.M[var3] = b.d[var3 * 3 + this.aj.P[var3]];
                  }
               }
            } else if ((this.aj.O & 1 << this.ec + 1) == 0) {
               ...
               this.aj.O = (byte)(this.aj.O | 1 << this.ec + 1);
            } else {
               ...
               this.aj.M[this.ec + 1] = (short)(this.aj.M[this.ec + 1] + b.d[(this.ec + 1) * 3 + this.aj.P[this.ec + 1]]);
               if (this.aj.M[this.ec + 1] > b.d[(this.ec + 1) * 3 + this.aj.P[this.ec + 1]]) {
                  this.aj.M[this.ec + 1] = b.d[(this.ec + 1) * 3 + this.aj.P[this.ec + 1]];
               }
            }
         }
         ...
         if (var2 != -1 && var1 != 50) {
            if (var1 != 53 && var2 != -5 && var1 != -6) {
               if (var1 == -7) {
                  ...
                  this.W();
                  this.b = 3;
                  if ((this.aj.O & 1 << this.aj.L) == 0 || this.aj.L == 0) {
                     this.aj.L = 1;
                  }

                  for (int var3 = 0; var3 < 8; var3++) {
                     this.aj.M[var3] = this.aj.T[var3];
                  }
   ...
   public final void v(int var1, int var2) {
      ...
      if (var1 != 54 && var1 != 50 && var2 != -4 && var2 != -1) {
         if (var1 == 52 || var1 == 56 || var2 == -3 || var2 == -2) {
            for (this.aj.L = S[this.aj.L]; (this.aj.O & 1 << this.aj.L) == 0 && var3 < 8; var3++) {
               this.aj.L = S[this.aj.L];
            }
         ...
         for (this.aj.L = R[this.aj.L]; (this.aj.O & 1 << this.aj.L) == 0 && var3 < 8; var3++) {
            this.aj.L = R[this.aj.L];
         }
      }
   }
      ...
      if (var2 == -1 || var1 == 50) {
         ...
         if (var1 == 53 || var2 == -5 || var1 == -6) {
            ...
            if (this.cu == 1) {
               ...
               for (int var3 = 0; var3 < 8; var3++) {
                  this.aj.N[var3] = this.aj.S[var3];
                  this.aj.P[var3] = this.aj.U[var3];
                  this.aj.M[var3] = this.aj.T[var3];
               }
      ...
      if (this.cD) {
         ...
         if (var1 == -6 || var1 == -7) {
            ...
            if (var2 == -1) {
               ...
               byte var7 = 0;
               if (this.aj.u == -1 && this.aj.al != 12) {
                  this.aj.o();
               } else if (this.aj.s >= 0) {
                  if (this.aj.g() && !this.aj.ao && this.ea != -1) {
                     if (!z) {
                        z = true;
                        E = this.aj.b() - 8 + (F >> 1);
                     }
                     ...
                     this.aj.a((byte)4);
                     this.cw = this.cv = 0;
                  } else if (this.aj.h() && this.aj.ao && this.ea != 1) {
                     if (!z) {
                        z = true;
                        E = this.aj.b() + 8 - (F >> 1);
                     }
               ...
               if (this.aj.s == 2) {
                  ...
                  if ((this.aj.O & 1) > 0 && this.aj.s != -1 && this.aj.al != 11 && this.aj.al != 14) {
                     this.cw = 0;
                     this.aj.a((byte)14);
                     this.aj.am = 1;
                     this.aj.D = 1;
                  ...
                  if (this.aj.G) {
                     ...
                     this.aj.k();
                     this.aj.t = 10;
                     if ((this.aj.O & 1) > 0 && this.aj.al != 14) {
                        this.cw = 0;
                        this.aj.a((byte)14);
                        this.aj.am = 1;
                        this.aj.D = 1;
                  ...
                  } else if (this.aj.f() && this.aj.ac == 0 && this.aj.al != 14 && this.aj.al != 11) {
                     this.aj.k();
                     this.aj.aa++;
                     this.aj.ag = G - 2;
                     if ((this.aj.O & 1) > 0) {
               ...
               if (z && this.aj.b() < E + (F >> 1) && this.aj.ad > 0) {
                  this.cw = this.cv = 0;
                  return;
               }
            } else if (var2 == -4) {
               ...
               byte var3 = this.aj.u();
               byte var4 = (byte)((this.aj.c() + K) / G);
               short var5;
               int var6 = var5 = this.V.a(var3, var4 - 1);
               var6 -= 36;
               var6 = 1 << var6;
               if ((this.aj.O & 1) > 0
                  && this.aj.s == -1
                  ...
                  && this.aj.al != 14
                  && this.aj.al != 8
                  && (this.F() || this.E() || this.aj.M[this.aj.L] <= 0 || (this.bw & var6) != 0 && var5 >= 36 && var5 <= 42)) {
                  this.cw = 0;
                  this.aj.D = 0;
                  this.aj.q();
                  return;
               ...
               if (this.aj.M[this.aj.L] > 0 && this.cx == 0) {
                  this.aj.p();
                  this.cx = 129;
                  dD++;
   ...
   public final void l(int var1) {
      ...
      byte var4 = this.al[var1].f;
      if (this.al[var1].f != -1 && var4 != 30 && (var4 < 15 || var4 > 17)) {
         int var5 = (this.al[var1].g >> 8) - this.al[var1].p;
         int var6 = (this.al[var1].h >> 8) - this.al[var1].q;
         int var7 = this.al[var1].p << 1;
         int var8 = this.al[var1].q << 1;
   ...
   public final void m(int var1) {
      ...
      if (var1 == -1) {
         for (int var10 = 49; var10 >= 0; var10--) {
            if (this.bn[var10] != -1
               && this.d(this.bl[var10] - (this.aj.ab >> 8)) <= 3 * F >> 1
               && this.d(this.bm[var10] - this.aj.c()) <= G * 2
               && this.a(
                  this.bl[var10],
                  this.bm[var10] + this.bo[var10],
                  aJ.getWidth(),
                  aJ.getHeight() >> 2,
                  (this.aj.ab >> 8) + (this.aj.ao ? b.o[this.aj.D] : -b.o[this.aj.D] - b.q[this.aj.D]),
                  this.aj.c() + b.p[this.aj.D],
                  b.q[this.aj.D],
                  b.r[this.aj.D]
               )) {
               this.a.c(4);
         ...
         byte var4 = this.ak[var1].f;
         if (this.ak[var1].f != -1 && var4 != 30 && (var4 < 15 || var4 > 17)) {
            int var5 = (this.ak[var1].g >> 8) - this.ak[var1].p;
            int var6 = (this.ak[var1].h >> 8) - this.ak[var1].q;
            int var7 = this.ak[var1].p << 1;
            int var8 = this.ak[var1].q << 1;
   ...
   public final void H() {
      ...
      for (int var4 = 11; var4 >= 0; var4--) {
         if (this.ck[var4] != -1) {
            ...
            int var5 = this.b((this.cg[var4] >> 8) + 9, this.ch[var4] >> 8, G - 19);
   ...
   public final void x(Graphics var1) {
      ...
      int var12 = 20 - this.aj.ai;
      int var16 = var10 >> 1;
      var1.drawImage(an, 0, 0, 0);
      var1.setColor(255, 255, 255);
      byte var13 = this.aj.L;
      if (this.aj.L != 6 && var13 != 0) {
         ratchetandclank.e.a(var1, String.valueOf(this.aj.M[var13]), 3 + var11 + 6, 4, 0);
      }

      ratchetandclank.e.a(var1, Integer.toString(this.aX), var8, 4, 24);
      ...
      if (this.aj.L != 0) {
         ...
         var1.drawImage(aE, 3, 4 - (this.aj.L - 1) * var10, 0);
      }
   }
   ...
   public final void y(Graphics var1) {
      if (A) {
         ...
         var1.setClip(176 - var3 >> 1, H, var3, var2);
         var1.drawImage(aE, 176 - var3 >> 1, H - 7 * var2, 0);
      }
   }
   ...
   public final void J() {
      ...
      byte var5 = 8;
      short var6 = this.aj.c();
      byte var7 = 16;
      byte var8 = K;

      for (int var1 = 49; var1 >= 0; var1--) {
         int var9 = this.aj.ab >> 8;
   ...
   public final void D(Graphics var1) {
      ...
      int var5 = this.ca * F + x;
      int var6 = this.cb * G + y;
      if (var5 < 176 && var5 + var2 >= 0 && var6 < 220 && var6 + var3 >= 0) {
         boolean var4 = false;
         if (0 < var3) {
            this.b(var1, var5, var6, var2, var3 - 0);
   ...
   public final void K() {
      if (this.ca != -1) {
         ...
         int var3 = this.ca * F;
         int var4 = this.cb * G;
         if (this.a(this.aj.b() - 11, this.aj.c() + L + 7, 18, 37, var3, var4, var1, var2)) {
            this.ca = this.cb = -1;
            this.cC = true;
            this.cI = cz[11];
            this.r(cA[11]);
   ...
   public final void E(Graphics var1) {
      for (int var2 = ba - 1; var2 >= 0; var2--) {
         if (this.ai[var2].Z != -1) {
            this.ai[var2].a(var1, var2, this.ai[var2].ah, x, y);
         }
      }

      this.aj.a(var1, this.aj.ah, x, y);
   ...
   public final void L() {
      ...
      for (int var1 = 9; var1 >= 0; var1--) {
         if (this.al[var1].f == -1) {
            boolean var2 = false;
            this.al[var1].g = F * 14 << 8;
            this.al[var1].h = G * 9 << 8;
            this.al[var1].f = 31;
            this.al[var1].o = 0;
            this.al[var1].r = 25;
            this.al[var1].p = j.b[31];
            this.al[var1].q = j.c[31];
            if (this.bK == 0 || this.bK == 1 || this.bK == 7) {
               this.al[var1].m = j.d[31] << 8;
   ...
   public final void C(int var1, int var2) {
      ...
      int var3 = (var1 >> 8) / F;
      int var4 = (var2 >> 8) / G;
      if (!this.V.b(var3, var4)) {
         if (this.V.b(var3, var4 - 1)) {
            var4--;
         } else if (this.V.b(var3, var4 + 1)) {
            var4++;
         } else if (this.V.b(var3 + 1, var4)) {
            var3++;
         } else {
            if (!this.V.b(var3 - 1, var4)) {
               return;
            }
   ...
   public final void M() {
      if (this.bJ[4] <= 0) {
         ...
         for (int var11 = 0; var11 < ba; var11++) {
            this.ai[var11].Z = -1;
         }
      ...
      if (this.bJ[var1] <= 0) {
         ...
         if (var2 + var4 + x >= 0 && var2 + x <= 176 && var3 + var5 + y >= 0 && var3 + y <= 220) {
            for (int var6 = 9; var6 >= 0; var6--) {
               byte var7 = this.ak[var6].f;
               if (this.ak[var6].f >= 0 && var7 != 30 && var7 != 15 && var7 != 16 && var7 != 17) {
                  int var10 = this.ak[var6].p;
                  int var11 = this.ak[var6].q;
                  int var8 = (this.ak[var6].g >> 8) - var10;
                  int var9 = (this.ak[var6].h >> 8) - var11;
   ...
   public final void c(Graphics var1, byte var2) {
      ...
      if (var5 - 3 < 176 && var6 < 220 && var5 - 3 + var3 >= 0 && var6 + var4 >= 0) {
         var1.setClip(var5 - (F >> 1), var6, var3, var4);
   ...
   public final void p(int var1) {
      if (var1 == bb) {
         ...
         this.aS = this.ai[var1].Z;
         this.aT = this.ai[var1].al;
         this.aU = this.ai[var1].aj;
         if (this.ai[var1].ap != 0) {
            if (this.ai[var1].ap == 1) {
               if (this.ai[var1].ao) {
                  this.aW = 4;
               } else {
                  this.aW = 2;
               }
            } else if (this.ai[var1].ap == 2) {
               if (this.ai[var1].ao) {
                  this.aW = 6;
               } else {
                  this.aW = 3;
               }
            } else if (this.ai[var1].ap == 3) {
               if (this.ai[var1].ao) {
                  this.aW = 1;
               } else {
                  this.aW = 7;
   ...
   public final void a(int var1, int var2, boolean var3, int var4) {
      short var5 = (short)(var1 * F + (F >> 1));
      short var6 = (short)(var2 * G + (G >> 1));
      if (var3) {
         this.bc[var4] = var5;
         this.bd[var4] = var6;
      } else {
   ...
   public final void a(int var1, int var2, int var3, int var4, int var5) {
      ...
      if ((this.bu[var5 + var6 * 50 >> 5] & 1 << var5 - (var5 >> 5 << 5)) != 0) {
         ...
         if (var4 == 2) {
            this.bl[var5] = (short)(var1 * F + (aJ.getWidth() >> 1));
         } else {
            this.bl[var5] = (short)(var1 * F + var4 * aJ.getWidth());
         }

         this.bm[var5] = (short)(var2 * G);
   ...
   public final void P() {
      ...
      for (short var2 = 0; var2 < 50; var2++) {
         if (this.bn[var2] != -1) {
            var7 = true;
            short var4;
            int var5 = (var4 = this.bm[var2]) / G;
            int var6 = this.bl[var2] / F;

            short var3;
            while (var7 && ((var3 = this.V.f[var6][var5 + 1]) < 19 || var3 > 27)) {
               for (short var1 = 0; var1 < 50; var1++) {
                  if (this.bn[var1] != -1 && var1 != var2 && this.bl[var1] == this.bl[var2] && this.bm[var1] == var4 + G) {
                     var7 = false;
                     break;
                  }
               }
               ...
               if (var7) {
                  this.bm[var2] = (short)(this.bm[var2] + G);
                  var4 += G;
                  var5++;
               }
            }
         ...
         if (this.bn[var2] != -1) {
            ...
            for (short var1 = 49; var1 >= 0; var1--) {
               if (this.bn[var1] != -1 && this.bl[var1] == this.bl[var2]) {
                  if (this.bm[var1] == var3 - G) {
                     this.bq[var2] = var1;
                     this.br[var1] = var2;
                  } else if (this.bm[var1] == var3 + G) {
                     this.br[var2] = var1;
                     this.bq[var1] = var2;
                  }
               }
   ...
   public final void c(int var1, int var2, int var3) {
      ...
      for (int var4 = 11; var4 >= 0; var4--) {
         if (this.ck[var4] == -1) {
            if (var3 == 0) {
               this.ck[var4] = (byte)(this.d(this.W.nextInt()) % 2);
            } else if (var3 == 1) {
               this.ck[var4] = 2;
            } else {
               this.ck[var4] = 3;
   ...
   public final void d(int var1, int var2, int var3) {
      for (int var4 = 3; var4 >= 0; var4--) {
         if (this.cq[var4] == -1) {
            ...
            if (var3 != 0 && var3 != 1) {
               if (var3 == 2) {
                  this.cm[var4] = (short)((var1 - 2) * F);
                  this.cn[var4] = (short)(var2 * G);
                  this.co[var4] = (short)(F << 1);
                  this.cp[var4] = 0;
                  return;
               }

               this.cm[var4] = (short)(var1 * F);
               this.cn[var4] = (short)((var2 - 2) * G);
               this.co[var4] = 0;
               this.cp[var4] = (short)(G << 1);
               return;
            }
      ...
      for (int var4 = 9; var4 >= 0; var4--) {
         if (this.ak[var4].f == -1) {
            ...
            if (var3 >= 9 && var3 <= 11 || var3 >= 15 && var3 <= 17) {
               this.ak[var4].p = 84;
               this.ak[var4].q = 11;
               var1 += (this.aj.ao ? 1 : -1) * 84 << 8;
            } else {
               this.ak[var4].p = j.b[var3];
               this.ak[var4].q = j.c[var3];
            }

            this.ak[var4].k = this.ak[var4].i = this.ak[var4].g = var1;
            this.ak[var4].l = this.ak[var4].j = this.ak[var4].h = var2;
            this.ak[var4].f = (byte)var3;
            this.ak[var4].m = (this.aj.ao ? 1 : -1) * j.d[var3] << 8;
            this.ak[var4].n = 0;
            this.ak[var4].o = 0;
            this.ak[var4].s = this.aj.ao ? var1 - this.aj.ab : this.aj.ab - var1;
            if (var3 >= 3 && var3 <= 5) {
               this.ak[var4].n = 768;
               return;
            }
   ...
   public final void a(int var1, int var2, int var3, boolean var4, boolean var5, int var6, byte var7) {
      for (int var8 = 9; var8 >= 0; var8--) {
         if (this.al[var8].f == -1) {
            this.al[var8].g = var1;
            this.al[var8].h = var2;
            this.al[var8].f = (byte)var3;
            this.al[var8].o = 0;
            this.al[var8].r = var7;
            this.al[var8].p = j.b[var3];
            this.al[var8].q = j.c[var3];
            if (var6 != 0 && var6 != 1) {
               if (var5) {
                  this.al[var8].m = (short)((var6 == 3 ? -1 : 1) * j.d[var3] << 8);
                  this.al[var8].n = 0;
               } else {
                  this.al[var8].m = 0;
                  this.al[var8].n = (short)((var4 ? -1 : 1) * j.d[var3] << 8);
               }
            } else if (var5) {
               this.al[var8].m = 0;
               if (var7 != 17 && var7 != 20 && var7 != 23) {
                  this.al[var8].n = (short)((var6 == 0 ? -1 : 1) * j.d[var3] << 8);
               } else {
                  this.al[var8].n = (short)((var6 == 0 ? 1 : -1) * j.d[var3] << 8);
               }
            } else {
               this.al[var8].m = (short)((var4 ? 1 : -1) * j.d[var3] << 8);
               this.al[var8].n = 0;
            }
   ...
   public final void a(int var1, int var2, byte var3, int var4) {
      ...
      this.ai[var4].ab = var1 * F + (F >> 1) << 8;
      this.ai[var4].aa = (byte)var2;
      this.ai[var4].ag = this.ai[var4].ad = this.ai[var4].ac = 0;
      this.ai[var4].ai = f.i[var3];
      this.ai[var4].ap = 0;
      this.ai[var4].ao = true;
      if (this.Z == 12 && this.aj.ab < this.ai[var4].ab) {
         this.ai[var4].ao = false;
      }

      this.ai[var4].G = false;
      this.ai[var4].u = false;
      this.ai[var4].E = 0;
      this.ai[var4].C = (byte)var4;
      this.ai[var4].w = 0;
      this.ai[var4].D = 0;
      this.ai[var4].E = 0;
      this.ai[var4].F = this.ai[var4].ab;
      if (this.ai[var4].Z == 1) {
         this.ai[var4].F = 0;
      }
      ...
      if (this.ai[var4].Z == 3) {
         this.ai[var4].ao = false;
         short var7;
         if ((var7 = this.V.a(var1 + 1, var2)) >= 19 && var7 <= 34) {
            this.ai[var4].ap = 3;
         }
         ...
         if ((var7 = this.V.a(var1, var2 - 1)) >= 19 && var7 <= 34) {
            this.ai[var4].ag = 3072;
            this.ai[var4].ap = 1;
         }
      }

      this.ai[var4].v = var3;
      this.ai[var4].a((byte)0);
      this.ai[var4].am = 1;
      this.ai[var4].ah = 1;
   }
   ...
   public final void G(Graphics var1) {
      ...
      for (int var2 = 0; var2 < 3; var2++) {
         if (this.bC[var2] == -128 || this.bC[var2] != 0 && (this.bw & this.bC[var2]) != 0) {
            int var4 = this.bD[var2] * F + x + (F - var7 >> 1);
            int var5 = this.bE[var2] * G + y;
      ...
      for (int var10 = 0; var10 < 3; var10++) {
         if (this.bF[var10] != -1) {
            int var9 = this.V.a(this.bF[var10], this.bG[var10]);
            var9 -= 36;
            var9 = 1 << var9;
            int var11 = this.bF[var10] * F + x + (F - 19 >> 1);
            int var12 = this.bG[var10] * G + y + G - 19;
   ...
   public final void q(int var1) {
      if (this.ai[var1].Z != -1 && this.ai[var1].al != 5) {
         byte var2 = 0;
         short var3 = this.ai[var1].c();
         short var4 = this.ai[var1].b();
         byte var5 = this.ai[var1].Z;
         byte var6 = f.a[var5];
         byte var7 = f.b[var5];
         byte var8 = f.c[var5];
         byte var9 = f.d[var5];
         if (var3 - var6 + var8 + x >= 0 && var3 - var6 + x <= 176 && var4 + var7 + var9 + y >= 0 && var4 + var7 + y <= 220) {
            for (int var10 = 9; var10 >= 0; var10--) {
               byte var11 = this.ak[var10].f;
               if (this.ak[var10].f >= 0
                  && var11 != 30
                  && (this.ak[var10].b() || var11 >= 9 && var11 <= 11 || var11 >= 15 && var11 <= 17 || var11 == 2 || var11 >= 21 && var11 <= 29)) {
                  int var12 = (this.ak[var10].g >> 8) - this.ak[var10].p;
                  int var13 = (this.ak[var10].h >> 8) - this.ak[var10].q;
                  if (this.a(var3 - var6, var4 + var7, var8, var9, var12, var13, this.ak[var10].p << 1, this.ak[var10].q << 1)) {
                     var2 = this.ak[var10].c();
                     if (var5 != 4 && var5 != 3 || var2 != 6) {
                        if (var11 >= 9 && var11 <= 11) {
                           int var14;
                           if ((var14 = this.d(this.aj.b() - var3)) < F) {
                              this.ai[var1].ai = (byte)(this.ai[var1].ai - j.a[var11]);
                           } else if (var14 >= F * 2 && var11 <= 10) {
                              this.ai[var1].ai = (byte)(this.ai[var1].ai - (j.a[var11] >> 2));
                           } else {
                              this.ai[var1].ai = (byte)(this.ai[var1].ai - (j.a[var11] >> 1));
                           }
                        } else {
                           this.ai[var1].ai = (byte)(this.ai[var1].ai - j.a[var11]);
                        }

                        this.ak[var10].a(false);
                        this.e(var3 << 8, (var4 << 8) + (K << 7), 30);
                        dE++;
                        if (this.ai[var1].ai <= 0 && this.ai[var1].al != 5) {
                           short var18 = this.X;
                           if (this.cV) {
                              var18 = 0;
                           }
                           ...
                           if (var2 == 6 && var5 != 4) {
                              ...
                              for (int var19 = 0; var19 < f.k[this.ai[var1].v]; var19++) {
                                 this.c((short)(this.ai[var1].ab >> 8), this.ai[var1].b(), 0);
                              }

                              this.ai[var1].Z = 4;
                              this.ai[var1].v = 24;
                              this.ai[var1].ai = f.i[24];
                              if (this.aj.P[6] < 2) {
                                 this.aj.N[6]++;
                              }
                              ...
                              dK[this.X]++;
                              this.ai[var1].a((byte)5);
                              this.ai[var1].am = 1;
                              if (var5 != 4) {
                                 for (int var16 = 0; var16 < f.k[this.ai[var1].v]; var16++) {
                                    this.c((short)(this.ai[var1].ab >> 8), this.ai[var1].b(), 0);
                                 }
                        ...
                        } else if (this.ai[var1].al != 2) {
                           this.ai[var1].a((byte)4);
                           this.ai[var1].an = 0;
                        }
   ...
   public final void R() {
      ...
      for (int var7 = 9; var7 >= 0; var7--) {
         ...
         byte var8 = this.al[var7].f;
         if (this.al[var7].f != -1 && var8 != 30 && this.al[var7].b()) {
            int var9 = (this.al[var7].g >> 8) - this.al[var7].p;
            int var10 = (this.al[var7].h >> 8) - this.al[var7].q;
            if (this.a(var1 - 11, var2 + 7, 18, 37, var9, var10, this.al[var7].p << 1, this.al[var7].q << 1)) {
               byte var11 = this.al[var7].r;
               if (var8 != 3 && var8 != 6 && var8 != 18) {
                  if (!f) {
                     this.aj.ai = (byte)(this.aj.ai - f.j[var11]);
                  }
      ...
      while (true) {
         ...
         while (true) {
            ...
            if ((var13 = var3.charAt(var12)) == ' ') {
               var9 += ratchetandclank.h.a(var13);
               var12++;
            ...
            int var19 = ratchetandclank.h.a(var13);
         ...
         if (var8 + var9 > var7 || var16 || var17) {
            ...
            if ((var6 & 1) > 0) {
               if (var12 - var11 > 0) {
                  ratchetandclank.e.a(var1, var14, var11, var12 - var11, 88, var5, var6);
               }
               ...
               if (var12 - var11 > 0) {
                  if (ratchetandclank.q == 3) {
                     ...
                     if ((var20 = (var25 = new String(var14, var11, var12 - var11)).indexOf("Informations-netzwerks")) >= 0) {
                        if (var20 == 0) {
                           ratchetandclank.e.a(var1, "Informationsnetzwerks", var4, var5, var6);
                           if (var25.length() > 22) {
                              var1.drawSubstring(var25, 22, var25.length() - 22, var4 + ratchetandclank.h.a("Informationsnetzwerks"), var5, var6);
                           }
                        } else {
                           var1.drawSubstring(var25, 0, var20, var4, var5, var6);
                           ratchetandclank.e.a(var1, "Informationsnetzwerks", var4 + ratchetandclank.h.a(var25, 0, var20), var5, var6);
                           if (var25.length() > var20 + 1 + 22) {
                              var1.drawSubstring(
                                 var25,
                                 var20 + 1 + 22,
                                 var25.length() - var20 - 1 - 22,
                                 var4 + ratchetandclank.h.a(var25, 0, var20) + ratchetandclank.h.a("Informationsnetzwerks"),
                                 var5,
                                 var6
                              );
                           }
                        ...
                        ratchetandclank.e.a(var1, var25, var4, var5, var6);
                     }
                  } else {
                     ratchetandclank.e.a(var1, var14, var11, var12 - var11, var4, var5, var6);
                  }
               }
   ...
   public final void r(int var1) {
      ...
      if (var1 == 112 && !this.h(4) && !this.h(5) && !this.h(6) && !this.h(7) && !this.h(9) && !this.h(10)) {
         ...
         this.cE = null;
         this.cE = this.a(ratchetandclank.n[var1], var3);
      } else if (var1 == 227) {
         Object[] var2 = new Object[]{new Integer(this.v()), new Integer(bR)};
         this.cE = null;
         this.cE = this.a(ratchetandclank.n[var1], var2);
      } else {
         this.cE = ratchetandclank.n[var1];
      }
   ...
   public final void a(byte[] var1) {
      ...
      this.a.a(this.cL, var1, 1);
      this.a.a(this.bT, var1, 5);
      this.a.a(this.bU, var1, 9);
      this.a.a(this.cJ, var1, 13);
      var1[17] = this.aj.O;

      for (int var2 = 0; var2 < 8; var2++) {
         var1[18 + var2] = this.aj.P[var2];
         this.a.a(this.aj.N[var2], var1, 26 + var2 * 2);
         this.a.a(this.aj.M[var2], var1, 42 + var2 * 2);
      }

      this.a.a(this.aX, var1, 58);
      var1[62] = this.bw;
      this.a.a(this.bx, var1, 63);
      this.a.a(this.by, var1, 67);
      this.a.a(this.cr, var1, 195);
      var1[199] = (byte)(this.bZ ? 1 : 0);
      this.a.a(this.di, var1, 200);
      this.a.a(this.cK, var1, 204);
      this.a.a(dA, var1, 208);
   ...
   public final void b(byte[] var1) {
      if (var1[0] == 2) {
         ...
         this.cL = this.a.a(var1, 1);
         this.bT = this.a.a(var1, 5);
         this.bU = this.a.a(var1, 9);
         this.cJ = this.a.a(var1, 13);
         this.aj.O = var1[17];

         for (int var2 = 0; var2 < 8; var2++) {
            this.aj.P[var2] = var1[18 + var2];
            this.aj.N[var2] = this.a.b(var1, 26 + var2 * 2);
            this.aj.M[var2] = this.a.b(var1, 42 + var2 * 2);
         }

         this.aX = this.a.a(var1, 58);
         this.bw = var1[62];
         this.bx = this.a.a(var1, 63);
         this.by = this.a.a(var1, 67);
         this.cr = this.a.a(var1, 195);
         this.bZ = var1[199] == 1;
         this.di = this.a.a(var1, 200);
         this.cK = this.a.a(var1, 204);
         dA = this.a.a(var1, 208);
         this.aa = var1[212] != 0;
         this.ac = var1[213];
         this.ec = this.cu = 0;
         this.W();
   ...
   public final void T() {
      if (this.b == 0) {
         int var1 = this.cx & 63;
         byte var2 = this.aj.P[this.aj.L];
         if (var1 > 0) {
            this.cx++;
            if (var1 >= b.g[var2][this.aj.L]) {
               if ((this.cx & 128) != 0) {
                  this.cx = 129;
                  this.aj.p();
               } else {
   ...
   public final int a(Graphics var1, String var2, int var3, int var4, int var5) {
      int var6 = 0;
      int var7 = ratchetandclank.e.a;
      var6 = ratchetandclank.e.a(var2);
      var1.setClip(var4, 0, var5 - var4, 220);
      ratchetandclank.e.a(var1, var2, this.l, var3, 20);
      this.l -= 2;
      if (this.l + var6 <= var4) {
         this.l = var5;
      }
   ...
   private int Y() {
      ...
      for (int var3 = 0; var3 < 8; var3++) {
         var1[var3] = b.d[var3 * 3 + this.aj.P[var3]] - this.aj.M[var3];
         switch (var3) {
            case 0:
               this.aZ[var3] = 0;
               break;
   ...
   public final int a(Graphics var1, String var2, int var3, int var4, int var5, int var6) {
      ...
      do {
         ...
         while (true) {
            ...
            if (var13 == ' ') {
               var8 += ratchetandclank.e.a(var13);
               var11++;
            ...
            int var19 = ratchetandclank.e.a(var13);
         ...
         if (var7 + var8 <= var6 && !var16 && !var17) {
            ...
            if (var11 - var10 > 0) {
               if ((var5 & 1) > 0) {
                  if (var11 - var10 > 0) {
                     ratchetandclank.e.a(var1, var14, var10, var11 - var10, 88, var4, var5);
                  }
               } else if (var11 - var10 > 0) {
                  ratchetandclank.e.a(var1, var14, var10, var11 - var10, var3, var4, var5);
               }
            }
